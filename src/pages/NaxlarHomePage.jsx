    ...
    <div className="homepage overflow-hidden">
      ...
      <section className="limited my-4">
        <div className="container">
          <div className="row">
            <div className="col-md-3 col-12 bg-secondary py-2 d-flex me-md-4" style={{height:"250px"}}>
                ...
                <div className="shop-now align-self-end d-flex justify-content-center flex-column align-items-center">
                    ...
                    <button className="btn btn-warning rounded-pill mb-4">Shop Now</button>
                </div>
            </div>
            <div className="col-md-8 col-12 bg-dark ms-md-5 ">
              <div className=" text-white d-flex flex-column align-items-end  p-3">
                ...
                <button className="btn btn-warning rounded-pill">Shop Now</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container-fluid">
              <div className=" row gy-3 ">
                  <div className="ad-box col-md-2 col-5 mx-auto mx-md-auto py-3 advert2 me-3 me-md-1 d-flex flex-column align-items-center justify-content-center">
                      <div className="icon mt-3 rounded-circle bg-light align-items-center d-flex justify-content-center" style={{width:'50px', height:'50px'}}>
                        <i className="fas fa-truck fs-4"></i>
                      </div>
                      <h6 className="fw-bold my-2">World Delivery</h6>
                      <p>We offer competirive prices on our 10 million plus product any range</p>
                  </div>
                  <div className="ad-box col-md-3 col-5 mx-md-auto mx-auto me-md-1 py-3 me-3 advert2 d-flex flex-column align-items-center justify-content-center">
                      <div className="icon mt-2 rounded-circle bg-light align-items-center d-flex justify-content-center" style={{width:'50px', height:'50px'}}>
                  ...
                  <div className="ad-box col-md-2 col-5 mx-auto mx-md-auto py-3 advert2 d-flex flex-column align-items-center justify-content-center">
                      ...
                      <h6 className="fw-bold my-2">World Delivery</h6>
                      <p className="">We offer competirive prices on our 10 million plus product any range</p>
                  </div>
        ...
        <div className="container-fluid mx-md-5 px-md-5 py-5">
          <div className="row">
            <div className="col-md-5 text-white">
                ...
                <p className="text-light">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolores nisi eveniet dicta velit eaque quos inventore illo aut cumque. Architecto.
                </p>
                <div className="buttons">
                
                  <button className="btn btn-light me-4 rounded-pill"><span><i className="fab fa-google-play me-1"></i></span>Google Play</button>
                  
                  <button className="btn btn-light rounded-pill"><span><i className="fab fa-app-store me-1"></i></span>App Store</button>
